...
typedef int32_t  s32;  	//signed           int
typedef int16_t s16;	//signed short     int
...
typedef __IO int32_t  vs32;	 //volatile signed int
typedef __IO int16_t  vs16;	 //volatile signed short int
typedef __IO int8_t   vs8;	 //volatile signed char

typedef __I int32_t vsc32;  /*!< Read Only */  //在没有定义__cplusplus时，__I展开为volatile const，否则为volatile
