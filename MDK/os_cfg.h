...
#define OS_LOWEST_PRIO           63    /* Defines the lowest priority that can be assigned ...         */  //ucosii最多支持64个就绪任务担，允许为254个用户任务
                                       /* ... MUST NEVER be higher than 254!                           */

#define OS_MAX_EVENTS            50    //175    /* Max. number of event control blocks in your application      */
